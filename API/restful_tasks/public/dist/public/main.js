...
let AppComponent = class AppComponent {
    ...
    ngOnInit() {
        ...
        this.str = "HELLO WELCOME TO DOM MANIPUlATION";
        this.snacks = ["Vanilla Bean", "brushed suede", "cookies"];
        this.loggedin = true;
        // this.randNum = Math.floor( (Math.random() * 2)+1);
        // this.onButtonClick();
        // this.onButtonClickParam(7);
        // this.onBUttonClickEvent(event)
    }
    getTasksFromService() {
    ...
    onButtonClickParam(num) {
        console.log(`CLICK WORKS WITH num param: ${num}`);
        let observable = this.tasksService.posttoServer({ data: 666 });
        observable.subscribe((data) => {
            console.log("GOT OUR LOGIC", data);
        });
    }
...
/* harmony import */ var _tasks_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./tasks.service */ "./src/app/tasks.service.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        providers: [_tasks_service__WEBPACK_IMPORTED_MODULE_6__["TasksService"]],
...
module.exports = __webpack_require__(/*! C:\Users\islam\Desktop\MEAN\API\restful_tasks\public\src\main.ts */"./src/main.ts");
