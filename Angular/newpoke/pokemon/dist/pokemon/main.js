...
AppComponent.ctorParameters = () => [
    { type: _poke_service__WEBPACK_IMPORTED_MODULE_2__["PokeService"] }
];
...
let PokeService = class PokeService {
    ...
    getPokemon() {
        let hooh = this.http.get('https://pokeapi.co/api/v2/pokemon/250/');
        hooh.subscribe((data) => console.log("HERE IS YOUR POKEMON HOOH", data));
    }
    superCool() {
        let hooh = this.http.get('https://pokeapi.co/api/v2/pokemon/250/');
        hooh.subscribe((data) => {
    ...
    bestMove() {
        let hooh = this.http.get('https://pokeapi.co/api/v2/pokemon/250/');
        hooh.subscribe((data) => {
            console.log(data.name + "'s coolest move is " + data.moves[10].move.name);
        });
    }
    sharedMove() {
        let regenerator = this.http.get('https://pokeapi.co/api/v2/ability/regenerator');
        regenerator.subscribe((data) => {
            console.log(data.pokemon.length + " Pokemon have the ability " + data.name);
        });
    }
};
PokeService.ctorParameters = () => [
...
module.exports = __webpack_require__(/*! C:\Users\islam\Desktop\MEAN\Angular\newpoke\pokemon\src\main.ts */"./src/main.ts");
