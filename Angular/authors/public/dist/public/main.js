...
/* harmony default export */ __webpack_exports__["default"] = ("<!DOCTYPE html>\n<html>\n<head>\n\t<title>Add an Author</title>\n</head>\n<body>\n<div>\n\t<h1>Add an Author!</h1>\n</div>\n<form (submit)=\"submitNew()\">\n  <div class=\"form-group\">\n    <label for=\"exampleInputEmail1\">Author's Name</label>\n    <input type=\"text\" class=\"form-control\"  aria-describedby=\"emailHelp\" name=\"newAuthor.name\" [(ngModel)] = \"newAuthor.name\" placeholder=\"Enter name\">\n  </div>\n  <button type=\"submit\" class=\"btn btn-primary\">Submit</button>\n</form>\n<div class=\"errors\">\n\t<h3>{{error}}</h3>\n</div>\n<div class=\"home\">\n\t<a [routerLink]=\"['/home']\">Home</a>\n</div>\n</body>\n</html>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!DOCTYPE html>\n<html>\n<head>\n\t<title>Edit an Author</title>\n</head>\n<body>\n<div>\n\t<h1>Edit an Author!</h1>\n</div>\n<form (submit)=\"newEdit()\">\n  <div class=\"form-group\">\n    <label for=\"exampleInputEmail1\">Author's Name</label>\n    <input type=\"text\" class=\"form-control\"  aria-describedby=\"emailHelp\" name=\"name\" [(ngModel)] = \"author.name\" placeholder=\"Enter name\">\n  </div>\n  <button type=\"submit\" class=\"btn btn-primary\">Submit</button>\n</form>\n<div class=\"home\">\n\t<a [routerLink]=\"['/home']\">Home</a>\n</div>\n</body>\n</html>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!DOCTYPE html>\n<html>\n<head>\n\t<link rel=\"stylesheet\" href=\"https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css\" integrity=\"sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T\" crossorigin=\"anonymous\">\n\t<title>Authors</title>\n</head>\n<body>\n\t<h1>We have quotes by:</h1>\n<table class=\"table table-striped\">\n  <thead>\n    <tr>\n      <th scope=\"col\">Author's Name</th>\n      <th scope=\"col\">Actions</th>\n    </tr>\n  </thead>\n  <tbody>\n    <tr *ngFor = \"let author of authors\">\n      <td>{{author.name}}</td>\n      <td><a [routerLink] = \"['/edit/',author._id]\">Edit</a> | <button (click) = \"deleteAuthor(author._id)\">Delete</button></td>\n    </tr>\n  </tbody>\n</table>\n<a [routerLink] = \"['/add']\">Add New Author!</a>\n</body>\n</html>");
...
/* harmony import */ var _authors_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../authors.service */ "./src/app/authors.service.ts");
...
let AddComponent = class AddComponent {
    ...
    submitNew() {
        let observable = this.authorsService.addAuthor(this.newAuthor);
...
AddComponent.ctorParameters = () => [
    { type: _authors_service__WEBPACK_IMPORTED_MODULE_2__["AuthorsService"] }
];
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        providers: [_authors_service__WEBPACK_IMPORTED_MODULE_7__["AuthorsService"]],
...
let EditComponent = class EditComponent {
    // params: any;
    constructor(authorsService, router, route) {
        this.authorsService = authorsService;
        this.router = router;
        this.route = route;
        this.author = {};
    ...
    ngOnInit() {
        this.route.paramMap.subscribe(params => {
            ...
            this.authorsService.findAuthor(id).subscribe(author => {
                this.author = author;
            });
        });
    }
    newEdit() {
        ...
        let observable = this.authorsService.editAuthor(this.author);
        observable.subscribe((data) => {
            if (this.error) {
                console.log("ERROR RIGHT OVER HERE");
            }
            else {
...
let HomeComponent = class HomeComponent {
    ...
    getAuthors() {
        ...
        observable.subscribe(data => {
            console.log(data);
            console.log("Display Page Works");
            this.authors = data["authors"];
        });
    }
    deleteAuthor(id) {
        let observable = this.authorsService.deleteAuthor(id);
        observable.subscribe(data => {
            console.log("DELETED");
            this.getAuthors();
        });
...
module.exports = __webpack_require__(/*! C:\Users\islam\Desktop\MEAN\Angular\authors\public\src\main.ts */"./src/main.ts");
