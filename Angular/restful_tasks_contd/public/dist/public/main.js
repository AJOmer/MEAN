...
/* harmony default export */ __webpack_exports__["default"] = ("<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n  <link rel=\"stylesheet\" href=\"https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css\" integrity=\"sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T\" crossorigin=\"anonymous\">\n  <title>CRUD RESTFUL</title>\n</head>\n<body>\n<div class=\"jumbotron\">\n  <h1 class=\"display-4\">{{title}}</h1>\n  <div class=\"header\">\n  <button class=\"mybtn\" (click) = \"toggleDisplay()\">Get All Tasks!</button>\n  <div *ngIf = 'display'>\n  <div *ngFor=\"let task of tasks; let idx = index\">\n    <p>{{task.title}} <button id=\"showbtn\" (click) = \"info(idx)\">SHOW</button></p>\n  </div>\n  <app-task *ngIf=\"selectedTask\" [taskToShow]=\"selectedTask\"></app-task>\n  </div>\n  <div class=\"info\" *ngIf = \"selectedTask\">\n    <p> Task: {{selectedTask.title}}</p>\n    <p> Task Details:{{selectedTask.description}}</p>\n    <button (click) = \"toggleEdit(selectedTask)\">Edit</button>\n    <button (click) = \"toggleDelete(selectedTask)\">Delete</button>\n  </div>\n  </div>\n  <div class=\"form\">\n    <h1>Create a new Task!</h1>\n    <form (submit) = \"onSubmit()\">\n<!--       <p>{{newTask | json }}</p> -->\n      <p>Title:<input type=\"text\" name=\"newTask.title\" [(ngModel)] =\"newTask.title\" /></p>\n      <p>Description:<input type=\"text\" name=\"newTask.description\" [(ngModel)] =\"newTask.description\"/></p>\n      <p>Completed:<input type=\"boolean\" name=\"newTask.completed\" [(ngModel)] =\"newTask.completed\" /></p>\n      <input type=\"submit\" value=\"Create Task\"/>\n    </form>\n  </div>\n</div>\n<div *ngIf=\"this.edittoggle != false\" class=\"edit\">\n  <h1>Edit your Task</h1>\n  <form (submit) = \"onEdit()\">\n<!--     <p>{{newTask | json}}</p> -->\n    <p>New Title: <input type=\"text\" name=\"title\" [(ngModel)] = \"editTask.title\"></p>\n    <p>New Description:<input type=\"text\" name=\"description\" [(ngModel)] =\"editTask.description\"></p>\n    <input type=\"submit\" value=\"Update\">\n  </form>\n</div>\n</body>\n</html>");
...
let AppComponent = class AppComponent {
    ...
    ngOnInit() {
        ...
        // this.findTasksFromService("5d8035710002310b40f6931d");
    }
    getTasksFromService() {
        let observable = this.tasksService.getTasks();
    ...
    findTasksFromService(id) {
        let observable = this.tasksService.findTask(id);
        observable.subscribe((data) => {
            console.log("HERE IS THE INFORMATION FOR", data);
    ...
    onSubmit() {
        let observable = this.tasksService.addTask(this.newTask);
        observable.subscribe(data => {
    ...
    onEdit() {
        let observable = this.tasksService.editTask(this.editTask);
        observable.subscribe(data => {
    ...
    toggleDelete(task) {
        let observable = this.tasksService.deleteTask(task);
        observable.subscribe((data) => {
            console.log("DELETED GOOD RIDDANCE", task);
            this.getTasksFromService();
        });
    }
};
...
class TasksService {
    ...
    deleteTask(task) {
        return this.http.delete(`/tasks/${task._id}`, task);
    }
};
...
module.exports = __webpack_require__(/*! C:\Users\islam\Desktop\MEAN\Angular\restful_tasks_contd\public\src\main.ts */"./src/main.ts");
